// Single line comment: just information
// Multiline comment: Spring Security related things. Uncomment these to use Spring Security
...
public class CredentialsService implements UserDetailsService {
    ...
    public boolean getIdPwd(int id, String pwd){
        Optional<Employee> opt=employeeRepo.findById(id);
        if (opt.isPresent()){
            Employee emp=opt.get();
